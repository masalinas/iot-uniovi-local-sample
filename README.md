...
The default password configured it's **admin/password**. If we want **securize** our node-RED service we must install node-red-admin package previously to creare a default admin password
